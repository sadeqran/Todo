      ...
      <ul className="list-group m-0 p-0 mt-2">
        {taskItems.map((t) => (
          ...
          >
            ...
            <span>
              {/* آیکون */}
              <i className={`me-3 pointer transition_200 text_hover_shadow ${t.done ? "fas fa-times text-warning" : "fas fa-check text-success"}`}
                onClick={()=>handleSetDoneTask(t.id)}></i>
            
              <i className="me-3 pointer fas fa-trash text-danger transition_200 text_hover_shadow" onClick={()=>handleDeleteTask(t.id)}></i>
            </span>
          </li>
        ))}
      </ul>
